...
{
    public class UnitOutfitSelectionView : PopupViewBase<UnitOutfitSelectionViewModel>
    {
        ...
        [SerializeField] private List<UnitOutfitSelectionCellView> products;
        ...
        private UnitOutfitSelectionCellView _currentProduct;

        private UnitOutfitSelectionCellView CurrentProduct
        {
            get => _currentProduct;
            set
            {
        ...
        protected override async void OnEnable()
        {
            ...
            for (var i = 0; i < productObjects.Count; i++)
            {
                ...
                if (products.ElementAtOrDefault(i) == null)
                    products.Add(_componentViewFactory.Create<UnitOutfitSelectionCellView>(productsParent));
        ...
        private void OnProductClick(UnitOutfitSelectionCellView cell)
        {
